...
_READY_SERVICES = {"IndiHome", "Telkomsel"}
...
def _plotly_chart(fig: go.Figure, key: str) -> None:
    """Render Plotly secara responsif dengan key yang selalu unik."""
    try:
        st.plotly_chart(
            fig,
            ...
            <div class="sent-v7-page">
                <section class="sent-v7-hero">
                    ...
                    <div class="sent-v7-hero-badges">
                        ...
                        <span class="sent-v7-hero-badge">IndiBiz • Data aktual aktif</span>
    ...
    try:
        ...
        fig.add_annotation(
            ...
            text=(
                ...
                f"<br><span style='font-size:11px;color:#8F8F8F'>{dominant_pct:.1f}% · {_format_number(total)} komentar</span>"
            ),
        )
            ...
            <section class="sent-v7-selector-wrap" aria-label="Panel pemilihan layanan">
                <div class="sent-v7-selector-head">
                    ...
                    <div class="sent-v7-selector-summary" aria-label="Ringkasan ketersediaan layanan">
                        ...
                        <span class="sent-v7-selector-summary-chip"><strong>2</strong> model siap</span>
...
def _create_wordcloud_figure(text: str, sentiment: str) -> plt.Figure:
    ...
    try:
        figure, axis = plt.subplots(figsize=(11.0, 6.4), dpi=200)
    ...
    try:
        ...
        def _render_single_wordcloud(column: Any, sentiment: str) -> None:
            ...
            with column:
                ...
                figure = _create_wordcloud_figure(text_content, sentiment)
                try:
        ...
        if view_mode == "Semua":
            ...
            figure = _create_wordcloud_figure(text_content, selected_sentiment)
            try:
                png_bytes = _figure_to_png_bytes(figure)
                st.markdown(
                    _wordcloud_viewer_html(
...
def _service_model_dir(layanan: str) -> tuple[Path, str]:
    """Tentukan folder model untuk layanan terpilih."""
    model_dir, state = resolve_model_folder_for_service(str(layanan or "IndiHome"))
    return Path(model_dir), str(state)
...
def load_service_model(layanan: str) -> tuple[Any | None, str]:
    ...
    Model prediksi manual tersedia untuk IndiHome dan Telkomsel.
    IndiBiz tetap ditolak secara eksplisit agar tidak memakai model yang salah.
    """
    try:
...
def render_sentiment() -> None:
    ...
    try:
        ...
        data_source = get_data_source_label(layanan_awal)
