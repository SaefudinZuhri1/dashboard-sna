# pages/home.py
# TAHAP 5 FASE 7 - OPTIMASI PERFORMA: cache agregasi Beranda agar kunjungan ulang tidak menghitung ulang.
...
def _service_plotly_chart(figure: go.Figure | None, **kwargs: Any) -> Any:
    """Render chart layanan secara aman tanpa mengubah konfigurasi visual."""
    try:
        if figure is None:
        ...
        LOGGER.exception("Grafik Beranda gagal dirender: %s", error)
        st.warning("Grafik tidak dapat ditampilkan.")
        return None
...
def load_indihome_data(demo_mode: bool = False) -> pd.DataFrame:
...
@st.cache_data(show_spinner=False)
def load_indibiz_data(demo_mode: bool = False) -> pd.DataFrame:
...
@st.cache_data(show_spinner=False)
def load_telkomsel_data(demo_mode: bool = False) -> pd.DataFrame:
...
@st.cache_data(show_spinner=False, max_entries=6)
def load_all_data(demo_mode: bool = False) -> pd.DataFrame:
    """Gabungkan IndiHome, IndiBiz, dan Telkomsel memakai pd.concat()."""
    try:
        df_indihome = load_indihome_data(demo_mode)
        df_indibiz = load_indibiz_data(demo_mode)
        df_telkomsel = load_telkomsel_data(demo_mode)
        df_all = pd.concat(
...
def _inject_home_light_mode_patch() -> None:
    """Terapkan koreksi visual Beranda khusus mode terang.

    Patch ini tidak dirender ketika mode gelap aktif. Selector dibatasi pada
    komponen Beranda agar warna dark mode dan halaman lain tetap utuh.
    """
    if _is_dark_mode():
        return
    ...
    try:
        st.markdown(
            """
            <style>
                /* Patch Tahap 5 Fase 5: konsistensi light mode Beranda. */

                /* Kontras teks sekunder pada area terang. */
                .home-v5-section-copy-v25,
                .home-v5-service-section-copy,
                .home-v5-service-copy,
                .home-v5-service-chart-copy,
                .home-v5-platform-chart-note,
                .home-v5-combined-card-copy,
                .home-v5-influencer-overview-copy-v23,
                .home-v5-influencer-rule-v23,
                ...
                /* Overview per platform: tetap berkarakter, tetapi menyatu dengan light mode. */
                div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-v5-platform-shell-marker) {
                    background:
                        radial-gradient(circle at 88% 12%, rgba(66, 165, 245, 0.12), transparent 26%),
                        radial-gradient(circle at 18% 0%, rgba(229, 57, 53, 0.09), transparent 22%),
                        linear-gradient(145deg, #FFFFFF, #F7FAFF) !important;
                    border-color: #D8E2F0 !important;
                    box-shadow: 0 16px 36px rgba(15, 23, 42, 0.10), inset 0 1px 0 rgba(255,255,255,0.9) !important;
                }

                div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-v5-platform-shell-marker):hover {
                    border-color: rgba(66, 165, 245, 0.50) !important;
                    box-shadow: 0 20px 42px rgba(30, 64, 175, 0.13), 0 0 0 1px rgba(66, 165, 245, 0.10) inset !important;
                }
                ...
                .home-v5-platform-highlight-card--dominant {
                    ...
                    border-color: color-mix(in srgb, var(--home-v5-platform-color, #42A5F5) 34%, #D7DFEA) !important;
                    box-shadow: 0 8px 20px rgba(15, 23, 42, 0.07), inset 0 1px 0 #FFFFFF !important;
                }

                .home-v5-platform-highlight-card:hover {
                    box-shadow: 0 14px 28px color-mix(in srgb, var(--home-v5-platform-color, #42A5F5) 13%, rgba(15,23,42,0.12)) !important;
                }
                ...
                .st-key-home_v5_toggle_platform_chart_size button {
                    ...
                    border-color: rgba(66, 165, 245, 0.46) !important;
                    box-shadow: 0 8px 20px rgba(30, 64, 175, 0.10) !important;
                    color: #1E3A5F !important;
                }

                .st-key-home_v5_toggle_platform_chart_size button:hover {
                    background: linear-gradient(145deg, #F6FAFF, #E2EEFF) !important;
                ...
                div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-v5-platform-shell-marker) [data-testid="stPlotlyChart"] {
                    ...
                    box-shadow: 0 8px 22px rgba(15, 23, 42, 0.07), inset 0 1px 0 #FFFFFF !important;
                }

                /* Influencer: hilangkan blok gelap besar pada light mode tanpa mengubah struktur. */
                div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-v5-influencer-section-marker) {
                    background:
                        radial-gradient(circle at 92% 8%, rgba(37, 244, 238, 0.09), transparent 25%),
                        radial-gradient(circle at 8% 0%, rgba(225, 48, 108, 0.08), transparent 24%),
                        linear-gradient(145deg, #FFFFFF, #F7F9FC) !important;
                    border-color: #D8E2EE !important;
                    box-shadow: 0 18px 40px rgba(15, 23, 42, 0.10), inset 0 1px 0 #FFFFFF !important;
                }

                .home-v5-influencer-overview-v23 {
                    background: linear-gradient(145deg, #FFFFFF, #F3F7FC) !important;
                    border-color: #DCE4EE !important;
                ...
                .home-v5-influencer-live-v23 {
                    ...
                    border-color: #A7E3BC !important;
                    color: #19713A !important;
                }

                .home-v5-influencer-summary-card-v23 {
                    background: linear-gradient(145deg, #FFFFFF, #F7F9FC) !important;
                    border-color: color-mix(in srgb, var(--home-v5-inf-accent) 32%, #D7DFEA) !important;
                    box-shadow: 0 7px 18px rgba(15, 23, 42, 0.06);
                }

                .home-v5-influencer-summary-icon-v23 {
                    background: color-mix(in srgb, var(--home-v5-inf-accent) 13%, #FFFFFF) !important;
                }
                ...
                .home-v5-influencer-summary-leader-v23 {
                    color: color-mix(in srgb, var(--home-v5-inf-accent) 72%, #243044) !important;
                }
                ...
                .st-key-home_v5_influencer_platform_focus label:hover {
                    background: linear-gradient(135deg, rgba(66,165,245,0.10), rgba(225,48,108,0.07)) !important;
                    border-color: rgba(66, 165, 245, 0.46) !important;
                }

                .st-key-home_v5_influencer_platform_focus label:has(input:checked) {
                    background: linear-gradient(135deg, #2563EB, #42A5F5) !important;
                    border-color: #93C5FD !important;
                }

                .st-key-home_v5_influencer_platform_focus label:has(input:checked) p,
                .st-key-home_v5_influencer_platform_focus label:has(input:checked) span {
                    color: #FFFFFF !important;
                }

                .home-v5-platform-influencer-badge-v23,
                .home-v5-account-avatar-v23 {
                    background: color-mix(in srgb, var(--home-v5-platform-accent, var(--home-v5-table-accent)) 12%, #FFFFFF) !important;
                }

                .home-v5-influencer-panel-v23 {
                    background: linear-gradient(145deg, #FFFFFF, #F8FAFC) !important;
                    border-color: color-mix(in srgb, var(--home-v5-table-accent) 30%, #D8E0EA) !important;
                    box-shadow: 0 10px 24px rgba(15, 23, 42, 0.07), inset 0 1px 0 #FFFFFF !important;
                }

                .home-v5-influencer-panel-v23:hover {
                    border-color: color-mix(in srgb, var(--home-v5-table-accent) 52%, #C9D3E0) !important;
                    box-shadow: 0 15px 30px rgba(15, 23, 42, 0.10) !important;
                }

                .home-v5-influencer-platform-chip-v23 {
                    background: color-mix(in srgb, var(--home-v5-table-accent) 11%, #FFFFFF) !important;
                    color: color-mix(in srgb, var(--home-v5-table-accent) 76%, #243044) !important;
                }
                ...
                .home-v5-influencer-table-v23 th {
                    background: linear-gradient(180deg, #EEF3F9, #E6EDF6) !important;
                    border-bottom-color: #CFD9E5 !important;
                ...
                .home-v5-influencer-table-v23 tbody tr:hover td {
                    background: color-mix(in srgb, var(--home-v5-table-accent) 8%, #FFFFFF) !important;
                }
                ...
                /* Panduan: card dan tombol lebih ringan, tanpa blok hitam berat. */
                div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-v5-guide-card-marker-v25) {
                    background:
                        radial-gradient(circle at 88% 8%, color-mix(in srgb, var(--home-v5-guide-accent, #E53935) 11%, transparent), transparent 32%),
                        linear-gradient(145deg, #FFFFFF, #F7F9FC) !important;
                    border-color: color-mix(in srgb, var(--home-v5-guide-accent, #E53935) 30%, #D7DFEA) !important;
                    box-shadow: 0 12px 28px rgba(15, 23, 42, 0.08), inset 0 1px 0 #FFFFFF !important;
                }

                div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-v5-guide-card-marker-v25):hover {
                    border-color: color-mix(in srgb, var(--home-v5-guide-accent, #E53935) 58%, #C8D2DF) !important;
                    box-shadow: 0 18px 34px color-mix(in srgb, var(--home-v5-guide-accent, #E53935) 10%, rgba(15,23,42,0.13)) !important;
                }

                .home-v5-guide-step-v25 {
                    color: color-mix(in srgb, var(--home-v5-guide-accent, #E53935) 76%, #283548) !important;
                }

                .home-v5-guide-micro-v25 {
                    color: color-mix(in srgb, var(--home-v5-guide-accent, #E53935) 72%, #354154) !important;
                }

                div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-v5-guide-card-marker-v25) .stButton button {
                    background: color-mix(in srgb, var(--home-v5-guide-accent, #E53935) 12%, #FFFFFF) !important;
                    border-color: color-mix(in srgb, var(--home-v5-guide-accent, #E53935) 48%, #D3DCE7) !important;
                    box-shadow: 0 7px 18px color-mix(in srgb, var(--home-v5-guide-accent, #E53935) 10%, transparent) !important;
                    color: color-mix(in srgb, var(--home-v5-guide-accent, #E53935) 78%, #1F2937) !important;
                }

                div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-v5-guide-card-marker-v25) .stButton button:hover {
                    background: color-mix(in srgb, var(--home-v5-guide-accent, #E53935) 18%, #FFFFFF) !important;
                    box-shadow: 0 11px 24px color-mix(in srgb, var(--home-v5-guide-accent, #E53935) 15%, transparent) !important;
                }

                /* Patch v1.1: tombol panduan light mode berawal terang, lalu berwarna saat hover. */
                .st-key-home_v5_guide_button_1 { --home-v5-guide-button-accent: #E53935; }
                .st-key-home_v5_guide_button_2 { --home-v5-guide-button-accent: #FF9800; }
                .st-key-home_v5_guide_button_3 { --home-v5-guide-button-accent: #42A5F5; }
                .st-key-home_v5_guide_button_4 { --home-v5-guide-button-accent: #4CAF50; }

                .st-key-home_v5_guide_button_1 button,
                .st-key-home_v5_guide_button_2 button,
                .st-key-home_v5_guide_button_3 button,
                .st-key-home_v5_guide_button_4 button,
                .st-key-home_v5_guide_button_1 button[kind="secondary"],
                .st-key-home_v5_guide_button_2 button[kind="secondary"],
                .st-key-home_v5_guide_button_3 button[kind="secondary"],
                .st-key-home_v5_guide_button_4 button[kind="secondary"],
                .st-key-home_v5_guide_button_1 button[data-testid="stBaseButton-secondary"],
                .st-key-home_v5_guide_button_2 button[data-testid="stBaseButton-secondary"],
                .st-key-home_v5_guide_button_3 button[data-testid="stBaseButton-secondary"],
                .st-key-home_v5_guide_button_4 button[data-testid="stBaseButton-secondary"] {
                    background: #FFFFFF !important;
                    background-color: #FFFFFF !important;
                    border-color: var(--home-v5-guide-button-accent, #E53935) !important;
                    box-shadow: 0 7px 18px color-mix(in srgb, var(--home-v5-guide-button-accent, #E53935) 12%, transparent) !important;
                    color: var(--home-v5-guide-button-accent, #E53935) !important;
                }

                .st-key-home_v5_guide_button_1 button p,
                .st-key-home_v5_guide_button_2 button p,
                .st-key-home_v5_guide_button_3 button p,
                .st-key-home_v5_guide_button_4 button p,
                .st-key-home_v5_guide_button_1 button span,
                .st-key-home_v5_guide_button_2 button span,
                .st-key-home_v5_guide_button_3 button span,
                .st-key-home_v5_guide_button_4 button span,
                .st-key-home_v5_guide_button_1 button [data-testid="stMarkdownContainer"],
                .st-key-home_v5_guide_button_2 button [data-testid="stMarkdownContainer"],
                .st-key-home_v5_guide_button_3 button [data-testid="stMarkdownContainer"],
                .st-key-home_v5_guide_button_4 button [data-testid="stMarkdownContainer"] {
                    color: var(--home-v5-guide-button-accent, #E53935) !important;
                }

                .st-key-home_v5_guide_button_1 button:hover,
                .st-key-home_v5_guide_button_2 button:hover,
                .st-key-home_v5_guide_button_3 button:hover,
                .st-key-home_v5_guide_button_4 button:hover {
                    background: var(--home-v5-guide-button-accent, #E53935) !important;
                    background-color: var(--home-v5-guide-button-accent, #E53935) !important;
                    border-color: var(--home-v5-guide-button-accent, #E53935) !important;
                    box-shadow: 0 12px 25px color-mix(in srgb, var(--home-v5-guide-button-accent, #E53935) 24%, transparent) !important;
                    color: #FFFFFF !important;
                    filter: none !important;
                    transform: translateY(-2px) !important;
                }

                .st-key-home_v5_guide_button_1 button:hover p,
                .st-key-home_v5_guide_button_2 button:hover p,
                .st-key-home_v5_guide_button_3 button:hover p,
                .st-key-home_v5_guide_button_4 button:hover p,
                .st-key-home_v5_guide_button_1 button:hover span,
                .st-key-home_v5_guide_button_2 button:hover span,
                .st-key-home_v5_guide_button_3 button:hover span,
                .st-key-home_v5_guide_button_4 button:hover span,
                .st-key-home_v5_guide_button_1 button:hover [data-testid="stMarkdownContainer"],
                .st-key-home_v5_guide_button_2 button:hover [data-testid="stMarkdownContainer"],
                .st-key-home_v5_guide_button_3 button:hover [data-testid="stMarkdownContainer"],
                .st-key-home_v5_guide_button_4 button:hover [data-testid="stMarkdownContainer"] {
                    color: #FFFFFF !important;
                }

                .st-key-home_v5_guide_button_1 button:focus-visible,
                .st-key-home_v5_guide_button_2 button:focus-visible,
                .st-key-home_v5_guide_button_3 button:focus-visible,
                .st-key-home_v5_guide_button_4 button:focus-visible {
                    outline: 3px solid color-mix(in srgb, var(--home-v5-guide-button-accent, #E53935) 32%, transparent) !important;
                    outline-offset: 2px !important;
                }

                /* Informasi penelitian: permukaan terang dan kontras teks stabil. */
                div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-v5-research-marker-v25) {
                    background:
                        radial-gradient(circle at 92% 4%, rgba(66,165,245,0.10), transparent 26%),
                        radial-gradient(circle at 4% 0%, rgba(229,57,53,0.08), transparent 24%),
                        linear-gradient(145deg, #FFFFFF, #F7F9FC) !important;
                    border-color: #D8E1EC !important;
                    box-shadow: 0 16px 34px rgba(15, 23, 42, 0.09), inset 0 1px 0 #FFFFFF !important;
                }

                .home-v5-research-tile-v25 {
                    background: linear-gradient(145deg, #FFFFFF, #F5F8FC) !important;
                    border-color: color-mix(in srgb, var(--home-v5-research-accent, #42A5F5) 28%, #D7DFEA) !important;
                ...
                /* Patch v1.2: expander metodologi tetap putih saat default, hover, dan terbuka. */
                div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-v5-research-marker-v25) [data-testid="stExpander"] details,
                div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-v5-research-marker-v25) [data-testid="stExpander"] details[open],
                div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-v5-research-marker-v25) [data-testid="stExpander"] summary,
                div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-v5-research-marker-v25) [data-testid="stExpander"] summary:hover,
                div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-v5-research-marker-v25) [data-testid="stExpander"] summary:focus,
                div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-v5-research-marker-v25) [data-testid="stExpander"] summary:active,
                div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-v5-research-marker-v25) [data-testid="stExpander"] [data-testid="stExpanderDetails"] {
                    background: #FFFFFF !important;
                    background-color: #FFFFFF !important;
                    color: #252B36 !important;
                }

                div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-v5-research-marker-v25) [data-testid="stExpander"] summary p,
                div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-v5-research-marker-v25) [data-testid="stExpander"] summary span,
                div[data-testid="stVerticalBlockBorderWrapper"]:has(.home-v5-research-marker-v25) [data-testid="stExpander"] summary svg {
                    color: #252B36 !important;
                ...
                .home-v5-method-step-v25:hover {
                    background: linear-gradient(135deg, rgba(229,57,53,0.07), rgba(66,165,245,0.08)) !important;
                }
            </style>
            """,
            unsafe_allow_html=True,
        ...
        st.error("Penyesuaian mode terang Beranda belum dapat dimuat.")
...
def _load_home_influencer_data(demo_mode: bool = False) -> tuple[pd.DataFrame, bool, str]:
    """Muat dan olah data SNA, lalu gunakan dummy bila proses gagal."""
    try:
        if demo_mode:
            demo_edges = pd.concat(
                [
                    get_demo_sna("IndiHome"),
                    get_demo_sna("IndiBiz"),
                    get_demo_sna("Telkomsel"),
                ],
                ignore_index=True,
            )
        ...
        annotations=[
            {
                "text": (
                    ...
                    "<br><span style='font-size:0.75rem /* FIX: minimum 12px agar terbaca di tablet */;letter-spacing:1px'>KOMENTAR</span>"
                ).replace(",", "."),
                "x": 0.5,
                "y": 0.5,
                "showarrow": False,
...
def _open_service_sentiment(service_name: str) -> None:
    ...
    try:
        ...
        st.session_state["active_service"] = service_name
...
@_DIALOG_DECORATOR("Tampilan Layar Penuh")
...
def render_home() -> None:
    ...
    try:
        ...
        service_status = (
            {"IndiHome": False, "IndiBiz": False, "Telkomsel": False}
            if demo_mode
            else {
