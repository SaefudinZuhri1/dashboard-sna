...
def _inject_login_css() -> None:
    ...
    st.markdown(
        ...
        body [data-testid="stAppViewContainer"] div[data-testid="stForm"] div[data-testid="stAlert"] {
            border-radius: 10px !important;
        }
...
def show_login_page() -> None:
    ...
    try:
        ...
        with st.form("login_form", clear_on_submit=False, border=True):
            ...
            st.caption("Versi 1.0 | Aulia Rahmadiva Wardana | ULBI 2026")
        ...
        st.error(f"Terjadi kesalahan saat login: {error}")
