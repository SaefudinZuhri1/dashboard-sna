...
def _buat_html_loading(judul: str, pesan: Iterable[str]) -> str:
    ...
    return f"""
        ...
        <section class="telkom-loading-overlay" role="status" aria-live="polite">
...
def _buat_html_loading_aksi(label: str = "Menganalisis komentar") -> str:
    ...
    return _compact_html(
        ...
        <section class="telkom-action-loader" role="status" aria-live="polite" aria-label="{label_aman}">
